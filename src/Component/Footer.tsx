                        ...
                        <div className="app101-general-partners-logos">
                            <div className="app101-general-companies theme02">
                                <ul>
                                    ...
                                    <li><a target="" href="/"><Image width={90} height={400} src="/menu_item/photo/10/delta-mix.png" alt="" /></a></li>
                                    <li><a target="" href="http://bluelight.eamaraldelta.com/"><Image width={90} height={400}
                                        src="/menu_item/photo/13/eamar-blue-light.png" alt="" /></a></li>
                                    <li><a target="" href="http://eamaraldelta.com/index"><Image width={90} height={400}
                                        src="/menu_item/photo/31/eamar-eldelta-blue.png" alt="" /></a></li>
                                    <li><a target="" href="http://eamarmix.eamaraldelta.com/"><Image width={90} height={400}
                                        src="/menu_item/photo/11/eamar-tashteb_edited.png" alt="" /></a></li>
                                    <li><a target="" href="http://ebdaa.eamaraldelta.com/"><Image width={90} height={400}
